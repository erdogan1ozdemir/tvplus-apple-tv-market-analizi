...
(function(){
  ...
  const SEKMELER = [
    ...
    {id:'entity',  label:'Dizi & Sezon',      Comp:T.EntityTab,
  ...
  const BIRINCIL = [['spor','Kategori',160],['org','Tür',200],['takim','Dizi',200],
                    ['durum','Durum',140],['yil','Çıkış Yılı',130],
                    ['st','Sayfa Tipi',170],['ent','Varlık Tipi',140]];
  // Ek analitik fasetler
  const EK = [['it','Intent',150],['hak','Meşru Erişim',165],['marka','Marka Tipi',160],
              ['belirsiz','Belirsiz Ad',140],['dil','Dil',110],['sezonSay','Sezon Sayısı',140],
              ['resmi','Apple Resmi',140]];
